    ...
    try:
        while True:
            ...
            if n == 3 and Triangle(row,col):
                print(points,"forms the vertices of a Triangle") 
            elif n == 4 and Parallelogram(row,col):
                print(points,"forms the vertices of a Parallelogram")
            elif n == 6 and Hexagon(row,col):
                print(points,"forms the vertices of a Hexagon")
            else:
                print(points," doesn't form the vertices of an acceptable figure")
